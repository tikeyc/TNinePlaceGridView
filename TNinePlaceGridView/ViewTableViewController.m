...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    TCustomCell *cell = [tableView dequeueReusableCellWithIdentifier:@"reuseIdentifier" forIndexPath:indexPath];
    
    cell.ninePlaceGridView.showImages = @[@"beauty.jpg",@"beauty1.jpg",@"beauty.jpg",
                                          @"beauty1.jpg",@"beauty.jpg",];
